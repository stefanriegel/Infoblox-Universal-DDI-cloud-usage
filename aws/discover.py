...
def main():
    ...
    try:
        ...
        type_to_objs = {}
        for obj in discovery.native_objects:
            type_to_objs.setdefault(obj.resource_type, []).append(obj)
        print(f"Discovered {len(discovery.native_objects)} resources:")
        ...
        counted = [obj for obj in discovery.native_objects if obj.requires_management_token]
        type_to_counted = {}
        for obj in counted:
