...
def main(args=None):
    ...
    try:
        ...
        unk = save_unknown_resources(native_objects, config.output_directory, timestamp, "azure")
        if unk:
        ...
        licensing_results = calculator.calculate_from_discovery_results(native_objects, provider='azure')
