...
class AWSDiscovery(BaseDiscovery):
    ...
    def _is_managed_service(self, tags: Dict[str, str]) -> bool:
        ...
        Uses exact tag key/value matches from constants to avoid false positives.
        """
        # Delegate to base class implementation which uses constants.py
        return super()._is_managed_service(tags)
