...
class GCPConfig(BaseConfig):
    ...
    def __init__(self, project_id: Optional[str] = None, regions: Optional[List[str]] = None, 
                 output_directory: str = "output", output_format: str = "txt"):
...
def get_gcp_credential():
    ...
    try:
        ...
        raise Exception(f"GCP credentials not found: {e}. Please run 'gcloud auth application-default login' or set GOOGLE_APPLICATION_CREDENTIALS.")
...
def _get_major_regions() -> List[str]:
    ...
    major_regions = [
        ...
        'us-east4', 'us-east5', 'us-central2', 'us-south1',
        'europe-west1', 'europe-west2', 'europe-west3', 'europe-west4',
        'europe-west6', 'europe-west8', 'europe-west9', 'europe-west10',
        'europe-west12', 'europe-central2', 'europe-north1',
        'asia-east1', 'asia-southeast1', 'asia-southeast2', 'asia-southeast3',
        'asia-northeast1', 'asia-northeast2', 'asia-northeast3',
        'asia-south1', 'asia-south2', 'australia-southeast1', 'australia-southeast2',
